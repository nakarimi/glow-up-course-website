...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl backdrop-blur-md bg-white/70 dark:bg-slate-900/70 border border-white/20 dark:border-white/10 shadow-lg text-card-foreground transition-all duration-300 hover:shadow-xl animate-fade-in",
      className
    )}
    {...props}
  />
